  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden select-none bg-black">
        ...
        <div className="absolute inset-0 z-20 flex flex-col items-center justify-center bg-black/60 backdrop-blur-sm">
          {!scanComplete ? (
            <>
              ...
              <div className="text-amber-400 font-mono text-lg tracking-[0.3em] animate-pulse">
              ...
              <div className="mt-6 flex gap-1.5">
                {[...Array(5)].map((_, i) => (
                  <div
                    key={i}
                    className="w-1.5 h-1.5 bg-amber-400 rounded-full animate-pulse-dot"
      ...
      >
        ...
        <p className="text-center text-lg md:text-xl mb-5 text-amber-400/80 font-light tracking-wide">
          ...
          {panels.map((panel, i) => (
            <div key={i} className="flex flex-col items-center gap-3">
              <div className="text-center">
                ...
                <p
                  className={`text-xs sm:text-sm font-mono tracking-wider transition-colors duration-500 ${
                    placed[i] ? "text-amber-400" : "text-white/80"
                  }`}
                >
                  {panel.name}
                </p>
              ...
              >
                <div
                  className={`absolute inset-0 border rounded-2xl transition-all duration-500 backdrop-blur-sm ${
                    placed[i]
                      ? "border-amber-400/70 bg-amber-400/10 animate-ripple"
                  ...
                  >
                    <path
                      ...
                      className={`transition-all duration-500 ${
                        placed[i]
                          ? "stroke-amber-400 fill-amber-400/20"
                          : "stroke-white/40 group-hover:stroke-white/60"
                      }`}
                      strokeWidth="8"
                      strokeLinecap="round"
                      strokeLinejoin="round"
                ...
                <div className="absolute -bottom-5 left-0 right-0 text-center">
                  <span
                    className={`text-[9px] tracking-[0.2em] font-mono transition-colors duration-500 ${
                      placed[i] ? "text-amber-400" : "text-white/40"
                    }`}
                  >
